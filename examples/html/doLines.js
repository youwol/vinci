        ...
        if (lineInfo.show) {
            ...
            let skin = kepler.createLineset2({
                ...
                parameters: {
                    ...
                    opacity   : lineInfo.opacity  !==undefined ? lineInfo.opacity   : 1,
                    dashed    : lineInfo.dashed   !==undefined ? lineInfo.dashed    : false,
                    dashScale : lineInfo.dashScale!==undefined ? lineInfo.dashScale : 0.1
                }
            })
            group.add( skin )
