...
addFaultToModel(buildFault([0,0,0, 1,1,0, 2,1,0, 3,1,0, 4,2,0]), model, 'bt')
...
fs.writeFileSync('/Users/fmaerten/data/vinci/grid/remote.ts', io.encodeGocadTS(grid)  , 'utf8', err => {})
fs.writeFileSync('/Users/fmaerten/data/vinci/pl/remote.pl'  , io.encodeGocadPL(faults), 'utf8', err => {})
